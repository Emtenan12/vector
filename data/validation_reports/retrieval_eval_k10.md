...
|---|---|---|---|---|
| dense | 64.8% | 59/91 | 0.486 | 1 |
| sparse | 72.5% | 66/91 | 0.416 | 2.0 |
| fused | 75.8% | 69/91 | 0.549 | 1 |
...
| typo | 45% (9/20) | 40% (8/20) | 50% (10/20) | 20 |
...
| 3 | typo | PASS (2) | PASS (8) | PASS (3) | tenets of multidoman operations |
...
| 4 | typo | PASS (5) | PASS (5) | PASS (1) | list the lvels of warfare |
...
| 9 | typo | PASS (2) | PASS (1) | PASS (1) | what is mutal trust in mission comand |
...
| 11 | typo | PASS (2) | PASS (9) | PASS (3) | steps of troop leadng procedures |
...
| 14 | typo | PASS (7) | FAIL | PASS (1) | elements of sustianment |
...
| 17 | typo | PASS (1) | PASS (6) | PASS (2) | 3 types of defensve operations |
...
| 19 | typo | PASS (2) | FAIL | PASS (2) | what is a moblie defense |
...
| 20 | typo | FAIL | PASS (1) | PASS (4) | four elemnts of decisive action + source |
